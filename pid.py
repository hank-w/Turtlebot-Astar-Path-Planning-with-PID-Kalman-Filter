...
class PID_ctrl:
    ...
    # old values: kp=1.2,kv=0.8,ki=0.2,
    # tuned new values:kp=0.2,kv=0.5,ki=0.2
    def __init__(self, type_, kp=0.2,kv=0.5,ki=0.2, history_length=3, filename_="errors.csv"):
